...
<main>
    ...
    <br>
    <div class="container">
      <div class="card my-5 py-3 px-5"
        style="background-color: #60A5FA;margin-left: 400px;margin-right: 400px; text-align: center;">
        <h1>Sign In</h1>
        <br>

        <form action="">
          <div class="mb-3">
            <input type="text" class="form-control p-2" style="border:none;border-radius: 30px;" placeholder="Username">
          </div>
          <div class="mb-3">
        ...
        <a href="officerhome.html">
          <button class="btn btn-dark p-2 rounded-pill w-100">
            <h3>Login</h3>
          </button>
        </a>
        ...
        <div class="rounded bg-dark">
          <div class="row py-3 justify-content-center">
            <div class="col">
              <img src="../images/fb.png" class="mx-4">
              <img src="../images/google.png" class="mx-4">
              <img src="../images/ig.png" class="mx-4">
            </div>
          </div>
        </div>
        <br>
